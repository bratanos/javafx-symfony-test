...
class getSecurity_Listener_UserChecker_LoginService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.listener.user_checker.login'] = new \Symfony\Component\Security\Http\EventListener\UserCheckerListener(new \App\Security\UserChecker());
    }
}
